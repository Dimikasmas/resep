...
<!-- Snacks Category -->
        <div class="category-card">
            ...
            <div class="menu-grid">
                <div class="menu-item">
                    <img src="{{ asset('snacks/mummy-sosis.webp') }}" alt="eat" class="filter-img">
                    <p class="menu-item-name">Mummy Sosis</p>
                </div>
                <div class="menu-item">
                    <img src="{{ asset('snacks/corndog-roti tawar.webp') }}" alt="eat" class="filter-img">
                    <p class="menu-item-name">Corndog Roti Tawar</p>
                </div>
                <div class="menu-item">
                    <img src="{{ asset('snacks/garlicbread-toast.jpg') }}" alt="eat" class="filter-img">
                    <p class="menu-item-name">Garlic Bread Toast</p>
                </div>
                <div class="menu-item">
                    <img src="{{ asset('snacks/hotdog-kentang.jpg') }}" alt="eat" class="filter-img">
                    <p class="menu-item-name">Hotang (Hotdog Kentang)</p>
                </div>
                <div class="menu-item">
                    <img src="{{ asset('snacks/sate_pisang.png') }}" alt="eat" class="filter-img">
                    <p class="menu-item-name">Sate Pisang Ovomaltine</p>
                </div>
                <div class="menu-item">
