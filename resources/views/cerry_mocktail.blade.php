...
<body>
    ...
    <div class="container">
        <div class="image-container">
            <img src="cerry_mocktail.png" alt="CHERRY MOCKTAIL" class="drink-image">
        </div>

        <div class="content">
            <div class="title">CHERRY MOCKTAIL</div>

            <p class="description">Cherry Mocktail adalah minuman non-alkohol yang memadukan sirup ceri, soda atau sparkling water, dan es batu. Rasanya manis-asam yang menyegarkan dengan warna merah cantik, cocok untuk suasana santai maupun acara spesial.
            </p>
