...
<head>
    ...
    <title>Secret Recipe Menu - Soup</title>
    ...
    <div class="w-full min-h-screen flex items-center justify-center p-4 md:p-8 lg:p-12">
        ...
        <div class="category-card rounded-2xl p-6 md:p-8 lg:p-10 shadow-2xl w-full h-full md:h-auto max-w-sm md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
            <div class="text-center mb-6 md:mb-8">
                <h2 class="text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Soup</h2>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6 lg:gap-8" id="menuGrid">
                <div class="menu-item rounded-xl p-4 md:p-5 lg:p-6 cursor-pointer" data-name="soup tahu sutra">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/sup_tahusutra.jpeg') }}" alt="Soup Tahu Sutra" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm md:text-base lg:text-lg font-medium text-center">Soup Tahu Sutra</p>
                </div>
                
                <div class="menu-item rounded-xl p-4 md:p-5 lg:p-6 cursor-pointer" data-name="soup miso tahu rumput laut">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/supmiso_tahurumputlaut.jpeg') }}" alt="Soup Miso" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm md:text-base lg:text-lg font-medium text-center">Soup Miso Tahu Rumput Laut</p>
                </div>
                
                <div class="menu-item rounded-xl p-4 md:p-5 lg:p-6 cursor-pointer" data-name="soup kale">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/sup_kale.png') }}" alt="Soup Kale" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm md:text-base lg:text-lg font-medium text-center">Soup Kale</p>
                </div>
                
                <div class="menu-item rounded-xl p-4 md:p-5 lg:p-6 cursor-pointer" data-name="soup kentang bawang putih">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/supkentang_bawangputih.jpeg') }}" alt="Soup Kentang" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm md:text-base lg:text-lg font-medium text-center">Soup Kentang Bawang Putih</p>
                </div>
                
                <div class="menu-item rounded-xl p-4 md:p-5 lg:p-6 cursor-pointer" data-name="clear onion soup">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/supclear_onion.png') }}" alt="Clear Onion Soup" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm md:text-base lg:text-lg font-medium text-center">Clear Onion Soup</p>
                </div>
