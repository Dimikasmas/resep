    ...
    <div class="max-w-md mx-auto">
        ...
        <div class="category-card rounded-2xl p-6 shadow-2xl">
            <div class="text-center mb-6">
                <h2 class="text-white text-3xl font-bold mb-4">Soup</h2>
            ...
            <div class="grid grid-cols-2 gap-4" id="menuGrid">
                <div class="menu-item rounded-xl p-4 cursor-pointer" data-name="soup tahu sutra">
                    ...
                    <p class="text-white text-sm font-medium text-center">Soup Tahu Sutra</p>
                </div>
                
                <div class="menu-item rounded-xl p-4 cursor-pointer" data-name="soup miso tahu rumput laut">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/supmiso_tahurumputlaut.jpeg') }}" alt="Soup Miso" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm font-medium text-center">Soup Miso Tahu Rumput Laut</p>
                </div>
                
                <div class="menu-item rounded-xl p-4 cursor-pointer" data-name="soup kale">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/sup_kale.png') }}" alt="Soup Kale" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm font-medium text-center">Soup Kale</p>
                </div>
                
                <div class="menu-item rounded-xl p-4 cursor-pointer" data-name="soup kentang bawang putih">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/supkentang_bawangputih.jpeg') }}" alt="Soup Kentang" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm font-medium text-center">Soup Kentang Bawang Putih</p>
                </div>
                
                <div class="menu-item rounded-xl p-4 cursor-pointer" data-name="clear onion soup">
                    <div class="aspect-square mb-3 overflow-hidden rounded-lg">
                        <img src="{{ asset('soup/supclear_onion.png') }}" alt="Clear Onion Soup" class="w-full h-full object-cover">
                    </div>
                    <p class="text-white text-sm font-medium text-center">Clear Onion Soup</p>
                </div>
